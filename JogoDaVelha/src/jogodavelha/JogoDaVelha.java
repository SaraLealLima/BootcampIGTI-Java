...
public class JogoDaVelha {
	...
	private Boolean verificarVencedor() {
		for (int i = 0; i < 3; i++) {
			...
			if (!horizontal1.equals("_") && horizontal1.equals(horizontal2) && horizontal1.equals(horizontal3)) {
				return true;
			}
			...
			if (!vertical1.equals("_") && vertical1.equals(vertical2) && vertical1.equals(vertical3)) {
			return true;
		 }
		}
		...
		if(!diagonal1.equals("_") && diagonal1.equals(diagonal2) && diagonal1.equals(diagonal3)) {
			return true;
		}
		...
		if(!diagonalInvertida1.equals("_") && diagonalInvertida1.equals(diagonalInvertida2) && diagonalInvertida1.equals(diagonalInvertida3)) {
			return true;
		}
		return false;
	}
